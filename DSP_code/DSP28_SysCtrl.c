...
// SysCtrlRegs.PCLKCR.bit.SCIENCLKB=1;
  ...
  XintfRegs.XTIMING0.bit.XRDLEAD = 0b11;
  XintfRegs.XTIMING0.bit.XWRLEAD = 0b11;
  XintfRegs.XTIMING0.bit.XRDACTIVE = 0b111;
  XintfRegs.XTIMING0.bit.XWRACTIVE = 0b111;
  XintfRegs.XTIMING0.bit.XRDTRAIL = 0b11;
  XintfRegs.XTIMING0.bit.XWRTRAIL = 0b11;

  XintfRegs.XTIMING1.bit.XRDLEAD = 0b11;
  XintfRegs.XTIMING1.bit.XWRLEAD = 0b11;
  XintfRegs.XTIMING1.bit.XRDACTIVE = 0b111;
  XintfRegs.XTIMING1.bit.XWRACTIVE = 0b111;
